namespace ReposteriaLili_API.Core.Dominio.Constantes
{
    public static class Constantes
    {
        ...
        public const int    CU10_CODIGO_EMPLEADOS_RECUPERADOS_SATISFATORIAMENTE = 2016;
        public const string CU10_MENSAJE_EMPLEADOS_RECUPERADOS_SATISFATORIAMENTE = "Los empleados se recuperaron satisfactoriamente";
        public const int    CU12_CODIGO_INVENTARIO_RECUPERADO_SATISFATORIAMENTE = 2017;
        public const string CU12_MENSAJE_INVENTARIO_RECUPERADO_SATISFATORIAMENTE = "Los productos del inevntario se recuperaron satisfactoriamente";
        ...
        public const int    CU10_CODIGO_NO_SE_ENCONTRARON_EMPLEADOS = 4022;
        public const string CU10_MENSAJE_NO_SE_ENCONTRARON_EMPLEADOS = "No se encotraron empleados registrados en la base de datos";
        public const int    CU12_CODIGO_NO_ENCONTRO_PRODUCTO_EN_INVENTARIO = 4023;
        public const string CU12_MENSAJE_NO_ENCONTRO_PRODUCTO_EN_INVENTARIO = "No se encotraron productos registrados en la base de datos";
