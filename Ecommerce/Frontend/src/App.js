...
import RegisterEmployee from "./components/security/RegisterEmployee";
import RegisterProduct from "./components/products/RegisterProduct";
import RegisterBranch from "./components/branches/RegisterBranch";
...
function App() {
  ...
  useEffect(() => {
    ...
    dispatch(getShoppingCart({}));//Desde el inicio se carga el shoping car id y si no existiera se generara uno en el servidor
      ...
      <div className="App">
        ...
        <div className="container container-fluid">
            <Routes>
              ...
              <Route exact path="/registerEmployees" element={<ProtectedRoute />}>
                <Route path="/registerEmployees" element={<RegisterEmployee />} />
              </Route>

              <Route exact path="/registerBranches" element={<ProtectedRoute />}>
                <Route path="/registerBranches" element={<RegisterBranch />} />
              </Route>

              <Route exact path="/registerProducts" element={<ProtectedRoute />}>
                <Route path="/registerProducts" element={<RegisterProduct />} />
              </Route>
