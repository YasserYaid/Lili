...
namespace Ecommerce.Infrastructure.Migrations
{
    ...
    [Migration("20240104010644_inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Domain.Branch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Domain.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Domain.Order", b =>
                {
                    ...
                    b.Property<string>("ImagenIncidenteClienteUrl")
                        .HasColumnType("NVARCHAR(2000)");

                    b.Property<string>("ImagenIncidenteRepartidorUrl")
                        .HasColumnType("NVARCHAR(2000)");
            ...
            modelBuilder.Entity("Ecommerce.Domain.Product", b =>
                {
                    ...
                    b.Property<string>("ImagenCodigoBarrasUrl")
                        .HasColumnType("NVARCHAR(4000)")
                        .HasColumnName("imagenCodigoBarrasUrl");

                    b.Property<string>("ImagenProductoFirebaseUrl")
                        .HasColumnType("NVARCHAR(4000)")
                        .HasColumnName("imagenProductoFirebaseUrl");
            ...
            modelBuilder.Entity("Ecommerce.Domain.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Domain.Client", b =>
                {
                    b.HasOne("Ecommerce.Domain.Usuario", "Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("Ecommerce.Domain.Employee", b =>
                {
                    b.HasOne("Ecommerce.Domain.Branch", "Branch")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("Ecommerce.Domain.Order", b =>
                {
                    ...
                    b.HasOne("Ecommerce.Domain.Employee", "Employee")
                        .WithMany("Orders")
